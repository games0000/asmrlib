...
const TAG_GROUPS = {
  "纯爱/日常": [
    "オールハッピー", "纯爱", "ラブラブ/あまあま", "甘々", "日常/生活", "ほのぼの", "健全", "癒し", "睡眠", "添い寝", "同床", "おやすみ"
  ],
  "非全年龄剧情/倾向": [
    "NTR", "寝取り", "寝取られ", "ハーレム", "逆ハーレム", "退廃/背徳/インモラル", "萌え"
  ],
  "背景/世界观/机制": [
    "オフィス/職場", "ミステリー", "同居", "同棲", "学園もの", "学校/学園", "オフィス", "異世界", "ファンタジー", "現代", "和風", "着物/和服", "系列作", "シリーズもの"
  ],
  "角色身份/人设": [
    "主従", "芸能人", "アイドル", "モデル", "双子姉妹", "女教師", "同級生/同僚", "悪役令嬢", "男主人公", "魔法使い/魔女", "お姉さん", "妹", "義妹", "幼馴染", "幼なじみ", "彼女", "彼氏", "恋人同士", "嫁", "旦那", "メイド", "先生", "生徒", "学生", "後輩", "先輩", "先輩/後輩", "上司", "部下", "人外", "人外娘/モンスター娘", "エルフ", "サキュバス/淫魔", "サキュバス", "幽霊", "吸血鬼", "お嬢様", "ギャル", "VTuber", "少女", "ボクっ娘", "百合", "OL", "巫女"
  ],
  "性格/属性/声线": [
    "無表情", "ダウナー", "淫乱", "处女", "処女", "ツンデレ", "ヤンデレ", "触ナー", "クール", "天然", "強気", "低音ボイス", "高音ボイス", "ロリ系ボイス", "ボイス", "ヤリチン/プレイボー本番なしボーイ"
  ],
  "外貌/体型": [
    "ネコミミ", "ツインテール", "ショートカット", "金髪", "メガネ", "兽耳", "獣耳", "巨乳", "爆乳", "巨乳/爆乳", "貧乳", "つるぺた", "ロリ", "ショタ", "おっぱい", "胸部", "おしり", "ふともも"
  ],
  "前戏/互动/边缘行为": [
    "色仕掛け", "マッサージ", "耳舐め", "耳かき", "囁き", "ささやき", "吐息", "キス", "起こし", "朝起こし", "耳ふー", "工作サポ", "自慰辅助", "オナサポ", "コスプレ", "制服", "水着", "脱衣", "裤子", "パンツ", "动物/ペット"
  ],
  "正戏/体位/绝顶表现": [
    "連続絶頂", "本番なし", "动画汁/液大量", "アニメ汁/液大量", "淫语", "淫語", "潮吹き", "ぶっかけ", "フェラチオ", "クンニ", "手コキ", "パイズリ", "イマラチオ", "イラマチオ", "アナル", "オナニー", "乳首責め", "中出し", "内射", "顔射", "大量射精", "ごっくん/食ザー", "妊娠/孕ませ", "イチャイチャ", "えっち", "淡白/あっさり", "オホ声"
  ],
  "控场/攻受/特殊性癖": [
    "逆転無し", "总受", "総受", "強気攻", "逆レ", "sissy", "痴女", "逆レイプ", "レイプ", "催眠", "洗脳", "阻薬", "トランス/暗示", "调教", "拘束", "SM", "支配", "フェチ", "複数プレイ/乱交", "女性優位", "男性受け", "特殊性癖", "异世界转生", "異世界転生", "电车", "電車", "おねショタ", "赤ちゃんプレイ"
  ],
  "精神控制/互动机制/音频系统": [
    "ざぁ～こ♡", "羞恥/恥辱", "マニアック/変態", "言語責め", "言語侵犯", "言葉責め", "罵倒", "焦らし", "オナニー指示", "トランス/暗示ボイス", "立体音響", "高音质", "高音質", "BGMなし", "文本付き", "テキスト付き", "日本語", "中国語", "环境音", "環境音", "睡眠導入", "ASMR", "バイノーラル/ダミヘ", "ダミーヘッド"
  ]
};
